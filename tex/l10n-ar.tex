...
\def\dummy#1#2{\framedtext[width=broad,offset=0pt,frame=off]{#2}} % XXX
...
\def\example#1{\exampleframed{\ltr{\tt #1}}} % XXX
\def\rexample#1{\rexampleframed{\tt #1}} % XXX
...
\unexpanded\def\type{\groupedcommand{\setgroupedtype\bidilre}{\bidipop}} % XXX
