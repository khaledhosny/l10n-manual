...
\setupbodyfont[adobearabic, 11pt]

\definefont[mal][name:Meera]
...
\def\rexample#1{\rexampleframed{\tt #1}}
...
\unexpanded\def\Type{\groupedcommand{\setgroupedtype\bidilre}{\bidipop}}
